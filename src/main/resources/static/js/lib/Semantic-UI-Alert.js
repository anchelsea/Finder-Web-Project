...
$.uiAlert = function(options) {
  var setUI = $.extend({
    ...
    var message = $(`<div onclick="goto('${setUI.link}')"  id="messages" class="ui icon message"  ${ setUI.bgcolors}  ><i class="'+setUI.icon+' icon" style="color: ${setUI.textcolor};"></i><i class="close icon" style="color: ${setUI.textcolor};" id="messageclose"></i><div style="color: ${setUI.textcolor}; margin-right: 10px;">   <div class="header">${setUI.textHead}</div>  <p> ${setUI.text}</p></div>  </div>`);
